Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pettersamuelsen/DraggableCollectionView"
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.authors      = [ 'Luke Scott', 'Rex Sheng' ]
  s.source       = { :git => "https://github.com/pettersamuelsen/DraggableCollectionView.git", :tag => s.version.to_s }
  s.platform     = :ios, '6.0'
  s.requires_arc = true
